"""
Django settings for communicator_48127 project.
...
ROOT_URLCONF = 'communicator_48127.urls'
...
WSGI_APPLICATION = 'communicator_48127.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "communicator_48127 API",
    "DESCRIPTION": "API documentation for communicator_48127 App",
    "VERSION": "v1",
}
